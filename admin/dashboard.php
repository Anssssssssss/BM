        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-header">
                <nav class="navbar navbar-expand-lg bg-white fixed-top">
                    <a class="navbar-brand" href="#">BAKERS KITCHEN</a>
                            ...
                            <li class="nav-item dropdown nav-user">
                                <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                        src="../Image/user.png" alt="" class="user-avatar-md rounded-circle"></a>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="view_orders.php"><i
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card bg-primary">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $select_users = "SELECT * FROM cake_shop_users_registrations1";
                                    $query_users = mysqli_query($conn, $select_users);
                                    $res_users = mysqli_num_rows($query_users);
                                    ?>
                                    <p class="card-text">Number of users in database =
                                        <h1 align=center><?php echo $res_users; ?></h1>
                                    </p>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card bg-brand">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $select_category = "SELECT * FROM cake_shop_category1";
                                    $query_category = mysqli_query($conn, $select_category);
                                    $res_category = mysqli_num_rows($query_category);
                                    ?>
                                    <p class="card-text">Number of categories in database =
                                        <h1 align=center><?php echo $res_category; ?></h1>
                                    </p>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card bg-secondary">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $select_product = "SELECT * FROM cake_shop_product1";
                                    $query_product = mysqli_query($conn, $select_product);
                                    $res_product = mysqli_num_rows($query_product);
                                    ?>
                                    <p class="card-text">Number of products in database =
                                        <h1 align=center><?php echo $res_product; ?></h1>
                                    </p>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card bg-success">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $select_orders = "SELECT * FROM cake_shop_orders1";
                                    $query_orders = mysqli_query($conn, $select_orders);
                                    $res_orders = mysqli_num_rows($query_orders);
                                    ?>
                                    <p class="card-text">Number of orders in database =
                                        <h1 align=center><?php echo $res_orders; ?></h1>
                                    </p>
